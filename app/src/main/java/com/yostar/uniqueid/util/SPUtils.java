...
public final class SPUtils {
  private static final String SP_NAME = "UniqueID";

  private static SPUtils spUtils;
  private SharedPreferences sp;

  private SPUtils(final String spName, final int mode) {
    if (UniqueIDApplication.getInstance() != null) {
      sp = UniqueIDApplication.getInstance().getSharedPreferences(SP_NAME, mode);
    }
  }
