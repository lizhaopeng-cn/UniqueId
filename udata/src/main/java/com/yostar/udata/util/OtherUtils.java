...
public class OtherUtils {
    ...
    public static String getNetworkOperatorName() {
        String opeType = "";
        // No sim
        if (!hasSim(UDataApplication.getInstance().getApplicationContext())) {
            return opeType;
        }

        TelephonyManager tm = (TelephonyManager) UDataApplication.getInstance().getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
